...
public class Constants {
    public static final String BASE_URL = "http://cloudeducate.com/";
    ...
    public static final String CONVERSATION_DISPLAY = "title";
    ...
    public static final String PREFERENCE_KEY = "prefrencekey";
